...
class ViewController: UIViewController {
    ...
    private func addConstraintsLabelTitleNovel() {
        NSLayoutConstraint.activate([
            labelTitleNovel.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 20),
            labelTitleNovel.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            labelTitleNovel.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16),
            labelTitleNovel.heightAnchor.constraint(equalToConstant: 18)
        ])
    }
    ...
    private func addConstraintsLabelTitleSeries() {
        NSLayoutConstraint.activate([
            labelTitleSeries.topAnchor.constraint(equalTo: collectionViewNovel.bottomAnchor, constant: 20),
            labelTitleSeries.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            labelTitleSeries.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16),
            labelTitleSeries.heightAnchor.constraint(equalToConstant: 18)
        ])
    }
    ...
    private func addConstraintsLabelTitleCine() {
        NSLayoutConstraint.activate([
            labelTitleCine.topAnchor.constraint(equalTo: collectionViewSeries.bottomAnchor, constant: 20),
            labelTitleCine.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 16),
            labelTitleCine.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -16),
            labelTitleCine.heightAnchor.constraint(equalToConstant: 18)
        ])
    }
...
extension ViewController: UITabBarDelegate {
    func tabBar(_ tabBar: UITabBar, didSelect item: UITabBarItem) {
        if item.tag == 0 {
            ...
            // Lógica para lidar com a seleção da opção "Favoritos"
        }
    }
}
